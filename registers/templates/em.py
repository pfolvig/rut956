...
registers = [
    ...
    Block(READ_HOLDING_REGISTERS,3185,2,{
        3185:Register('CMP_on',number_int,2,1),
        3186:Register('CMP_off',number_int,2,1),
    }),
    Block(READ_HOLDING_REGISTERS,1,3,{
        1:Register('voltage_L1_N',number_int,2,1),
        2:Register('voltage_L2_N',number_int,2,1),
        3:Register('voltage_L3_N',number_int,2,1),
    }),
    Block(READ_HOLDING_REGISTERS,5,3,{
        5:Register('voltage_L1_L2',number_int,2,1),
        6:Register('voltage_L2_L3',number_int,2,1),
        7:Register('voltage_L3_L1',number_int,2,1),
    }),
    Block(READ_HOLDING_REGISTERS,8,5,{
        8:Register('current_L1',number_dec,2,1),
        9:Register('current_L2',number_dec,2,1),
        10:Register('current_L3',number_dec,2,1),
        11:Register('rpm',number_int,1,1),
        12:Register('freq',number_dec,1,1),
     }), 
     Block(READ_HOLDING_REGISTERS,14,5,{    
        14:Register('realpwr',number_dec,2,1),
        15:Register('gen_kw_L1',number_dec,2,1),
        16:Register('gen_kw_L2',number_dec,2,1),
        17:Register('gen_kw_L3',number_dec,2,1),
        18:Register('nominal_kva',number_dec,2,1),
    }),
    Block(READ_HOLDING_REGISTERS,151,4,{
	151:Register('aio_1',number_int,2,1),
        152:Register('aio_2',number_int,2,1),
	153:Register('aio_3',number_int,2,1),
        154:Register('aio_4',number_int,2,1),  
    }),
